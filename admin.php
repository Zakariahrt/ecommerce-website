                    ...
                    <ul>
						...
						<?php
							if (!isset($_SESSION['user_type'])) {
								...
								echo '<li><a href="admin.php">Admin Panel</a><span class="icon"><i class="fa fa-lock"></i></span></li>';
		...
		<div class="new-wrapper">
			<?php
				...
				if (isset($_POST['ajouter'])) {
					...
					$sql = "INSERT INTO produit (name, price, description) VALUES ('$name', '$price','$description')";
